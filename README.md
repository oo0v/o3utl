...
- `FFmpeg-H264-LT_MMD_gbrp` - High quality H.264 (constqp) **[For MMD users, Converts full-range RGB (sRGB gamma, BT.709 primaries) to full-range YUV (BT.709) preserving original colors]**
